    ...
    $.extend(Plugin.prototype, {
        ...
        init: function () {
            ...
            if (this.settings.FlipX === true) {
                var flipClass = 'flip';
                var backClass = 'back';
                this._filpIt(backClass, flipClass,thisSettings,thisElement);
            }
            else {
                var flipClass = 'flipY';
                var backClass = 'backY';
        ...
        _filpIt: function (backClass, flipClass,thisSettings,thisElement) {

            var $hoverPanel =
                $('<div class="hover panel">').css({
                    'width': this.element.css('width'),
                    'height': this.element.css('height'),
                    'background': checkForFrontColor()
                });

            function checkForFrontColor() {
                if (thisSettings.FrontColor !== 'true') {
                    thisElement.css({'background':thisSettings.FrontColor});

                    return thisSettings.FrontColor;
                } else {
                    return thisElement.css("background-color");
                }
            }

            function checkForBackColor(){
                if (thisSettings.BackColor !== 'true') {
                    thisElement.css({'background':thisSettings.Background});

                    return thisSettings.Background;
                } else {
                    return thisElement.css("background-color");
                }
            }
