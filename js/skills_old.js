...
(function ($, window, document, undefined) {
    ...
    var badgeStyle =
        ...
        " color: rgba(18, 18, 18, 0.75);" +
            ...
            //" text-align: left;"+
            //" white-space: nowrap;"+
            //" perspective-origin: 62.5px 22px;"+
            //" transform-origin: 62.5px 22px;"+
        ...
        " padding: 3px 18px;"
    //" transition: border-color 0.15s ease 0s, background-color 0.15s ease 0s, color 0.15s ease 0s;";
    ...
    $.extend(Plugin.prototype, {
        ...
        style: function Style(colorStart, colorNext, colorEnd) {
            var style = "<style id='_skills_'>" +
               ...
               //
                ...
                " background: " + colorStart + " none repeat scroll 0% 0% / auto padding-box border-box;" +
                ...
                " perspective-origin: 46px 7.5px;" +
                " transform-origin: 46px 7.5px;" +
                " background: " + colorNext + " none repeat scroll 0% 0% / auto padding-box border-box;" +
                " border: 0px none rgb(101, 115, 128);" +
                " /*border-radius: 15px 0 0 15px;*/" +
                " font: normal normal 500 normal 10px/8px 'Gotham Rounded A', 'Gotham Rounded B', 'Helvetica Neue', Helvetica, Arial, sans-serif;" +
                " outline: rgb(101, 115, 128) none 0px;" +
                ...
                " perspective-origin: 46px 7.5px;" +
                " transform-origin: 46px 7.5px;" +
                " background: " + colorEnd + " none repeat scroll 0% 0% / auto padding-box border-box;" +
                " border: 0px none rgb(101, 115, 128);" +
